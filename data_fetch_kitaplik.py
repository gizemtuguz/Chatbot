...
starting_url = 'https://kitaplik.epati.com.tr/'
visited = set()
...
def parse_page(url):
    ...
    elements = soup.find_all(['h1', 'h3', 'p', 'table', 'img', 'ul'])           #türkçe kitaplığın html dosyaında h4 kullanılmadığı için buraya dahil edilmedi
    ...
    for link in soup.find_all('a', href=True):
        ...
        if len(path_parts) == 2 and len(path_parts[1]) == 1 and path_parts[1].isalpha():
            full_url = urljoin(starting_url, f'terimler-sozlugu//{path_parts[1]}/')
